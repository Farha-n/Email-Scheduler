...
export const checkHourlyLimit = async (senderEmail, limit) => {
    ...
    return {1, current}
  `;
    const result = (await redisConnection.eval(script, 1, key, limit, ttlSeconds));
